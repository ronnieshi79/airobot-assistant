...
abstract class PopupServiceItem {
    ...
    abstract val serviceType: PopupServiceType
    ...
    /** Sub-dial icon */
    abstract val subDialIcon: androidx.compose.ui.graphics.vector.ImageVector?
    ...
    @Composable
    abstract fun getSubDialColor(): androidx.compose.ui.graphics.Color
